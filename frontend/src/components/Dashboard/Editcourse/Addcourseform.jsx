...
const Step=[{id:"1",name:"Course Information"},{id:"2",name:"Course Builder"},{id:"3",name:"Publish"}];
    ...
    Step.map((ele,index)=>{
        return (
         <div key={index} className="flex relative ">
           {/* number sec  */}
            {/* <div className={`${Step.id<=step?`${Step.id==step?"border-[#FFD60A] bg-[#151309] text-[#FFD60A]":"bg-[#FFD60A]"}`:"border-[#2C333F] text-[18px] text-[#838894] bg-[#424854]"} w-[34px] h-[34px] rounded-full border-2`}>{Step.id<step?(<TiTick/>):(Step.id)}</div> */}
                <div
