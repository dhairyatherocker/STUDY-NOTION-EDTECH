...
const Thumbnail = ({ name, register, errors, label, setValue, getValues }) => {
  ...
  useEffect(() => {
    if (editCourse && course?.thumbnail) {
      // If in edit mode and course has thumbnail, set the preview to that URL
      ...
      >
        {previewSource ? (
          ...
          <div className="flex flex-col items-center gap-2 p-4 text-center bg-[#3f4455]">
            <div className="rounded-full w-[46px] h-[46px] bg-[#171717] flex justify-center items-center">
